...
public class ImpalaConfig {
    @ConfigSet(value = "ext.impala.jdbc.url")
    private String impalaJDBCUrl;
    @ConfigSet(value = "ext.impala.jdbc.table")
    private String impalaJDBCTable;

    public String getImpalaJDBCUrl() {
        return impalaJDBCUrl;
    }

    public String getImpalaJDBCTable() {
        return impalaJDBCTable;
    }
}
