...
import com.gridsum.datadivertor.utils.DateUtil;
...
public class DateTimeSlot {
    ...
    public String toString() {
        return String.format("(%s, %s]", DateUtil.dateToString(
                fetchStartTime, DateUtil.SDF_DATETIME), DateUtil.dateToString(fetchEndTime, DateUtil.SDF_DATETIME));
    }
}
